...
// // 原因： 在React的setState函数实现中，
// 会根据一个变量isBatchingUpdates判断是直接更新this.state还是放到队列中回头再说，
// 而isBatchingUpdates默认是false，也就表示setState会同步更新this.state，但是，
// 有一个函数batchedUpdates，这个函数会把isBatchingUpdates修改为true，
...
// 3、setTimeout 中的代码，触发时 isBatchingUpdates 为 false，
// 所以能够直接进行更新，所以连着输出 2，3。
